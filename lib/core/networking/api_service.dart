...
abstract class ApiService {
  ...
  @POST(ApiEndpoints.uploadChatImage)
  @MultiPart()
  Future<ChatMessageModel> uploadChatImage(
      @Header("Authorization") String token,
      @Part(name: 'receiverId') String receiverId,
      @Part(name: 'image') MultipartFile image, {
  ...
  @GET(ApiEndpoints.notificationPreferences)
  Future<NotificationPreferencesResponse> getNotificationPreferences(
      @Header("Authorization") String token,
      );

  @PUT(ApiEndpoints.notificationPreferences)
  ...
  @GET(ApiEndpoints.unreadNotifications)
  Future<UnreadCountResponse> getUnreadNotificationsCount(
      @Header("Authorization") String token,
      );

  @PATCH(ApiEndpoints.markNotificationRead)
  Future<MessageModel> markNotificationAsRead(
      @Header("Authorization") String token,
      @Path("id") String id,
      );

  @PATCH(ApiEndpoints.markAllNotificationsRead)
  Future<MarkAllReadResponse> markAllNotificationsAsRead(
      @Header("Authorization") String token,
      );
