...
class _ChatScreenState extends State<ChatScreen> {
  ...
  String? _token;
  String? _currentUserId; // ✅ read from storage, not from constructor
  ...
  Future<void> _initAndConnect() async {
    ...
    final userId = await prefs.getSecureData('id'); // ✅ always reliable
                  ...
                  success: (messages) {
                    ...
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final isMine = msg.sender?.id == _currentUserId; // ✅ fixed
